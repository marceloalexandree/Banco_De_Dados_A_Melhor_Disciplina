...
BEGIN
    ...
    livros_loop: LOOP
        FETCH cursor_livros_autor INTO v_titulo_livro;
        ...
        IF lista_titulos <> '' THEN
            SET lista_titulos = CONCAT(lista_titulos, ', ', v_titulo_livro);
        ELSE
            SET lista_titulos = v_titulo_livro;
        END IF;
    END LOOP livros_loop;
